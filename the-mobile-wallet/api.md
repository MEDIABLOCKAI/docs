...
## CMN-studio-backend v0.1.0

The CMN Blockchain Studio REST API for accessing the data and the services of the CMN Blockchain network in a simple way. You can use this API to query and interact with the objects of the CMN Blockchain network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and CMN Blockchain network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(CMN Blockchain\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the CMN Blockchain network |
...
| homeBridgeAddress | `String` | Bridge address on the CMN Blockchain network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the CMN Blockchain network |
...
Community is a set of contracts and services. Members of the community are users of the CMN Blockchain network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the CMN Blockchain network |
| homeTokenAddress | `String` | Address of the community token on the CMN Blockchain network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the CMN Blockchain network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the CMN Blockchain network |
...
Entity is an account on the CMN Blockchain network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on CMN Blockchain network |
...
Tokens are compatible with the CMN20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
...
| networkType | `String` | Network type where the token is issued: mainnet/ropsten/CMN |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| networkType | `String` | mainnet/ropsten/CMN |
| page | `Number` | Page number for pagination |
