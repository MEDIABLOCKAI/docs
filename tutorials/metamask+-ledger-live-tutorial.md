...
This tutorial will walk you through the steps needed to connect your Ledger to Metamask and use it to transact on CMN Blockchain after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change the network to “CMN Blockchain network” and perform the transactions on CMN Blockchain network through your Ledger device.

Note: To learn how to add CMN Blockchain RPC follow [this link.](https://doc.cmnscan.com/the-CMN-studio/getting-started/how-to-add-CMN-to-your-metamask)
